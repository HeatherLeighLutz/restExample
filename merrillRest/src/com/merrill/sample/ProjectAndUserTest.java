...
public class ProjectAndUserTest {
	...
	static class TestExecutor implements Runnable {
		...
		public void run() {
			...
			try {
				...
				String jwt = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJiYTAxYTk0MC0xMGQxLTRlMTUtODBiZS1iM2VjMzM3YmExZDQiLCJncm91cCI6ImNsaWVudCIsImV4cCI6MTQ3MTQzMTI1OCwic2NvcGUiOltdLCJpc3MiOiJpYW0ubWVycmlsbGNvcnAuY29tIiwiYXVkIjoiamF2ZWxpbm1jLmNvbSIsIlVzZXJOYW1lIjoidGVzdHVzZXIzQG1haWxpbmF0b3IuY29tIn0.e3iVmhnQSqYBo54s2cIos0bUA58sOaZdCipN_K0vepc";
				...
				int projectsToFetch = 20;
				List<UserDetails.Project> projectArray = user.projects;
				for (int k = 0; (k < projectsToFetch && k < projectArray.size()); k++) {
					UserDetails.Project project = projectArray.get(k);
